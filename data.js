...
const PROFILE_DATA = {
  ...
  metrics: [
    ...
    { value: "15+", label: "3D CAD Assemblies", icon: "model_training" }
  ],
  ...
  // Video Demonstration Registry
  videos: [
    {
      title: "EcoFloat Catamaran Autonomous Navigation",
      category: "Project videos",
      filePath: "assets/videos/catamaran_test.mp4", // Users can drop .mp4 files here
      duration: "0:45",
      description: "Onboard tracking feed testing the thruster PWM signals outputs and IMU compass alignment calibration registers.",
      date: "2026-04-17",
      tags: ["ROS Navigation", "Catamaran Test", "Autonomous path"],
      relatedContent: { text: "Project EcoFloat", link: "ecofloat" }
    },
    {
      title: "Seed Spreader Gearing Mechanical Simulation",
      category: "CAD models simulations",
      filePath: "assets/videos/spreader_simulation.mp4",
      duration: "0:30",
      description: "Fusion 360 motion study validating gear contact profiles and clearances tolerance offsets.",
      date: "2025-05-02",
      tags: ["Motion Study", "Gears clearance", "Rotation study"],
      relatedContent: { text: "Seed Spreader Gearing", link: "seed-spreader" }
    }
  ],
